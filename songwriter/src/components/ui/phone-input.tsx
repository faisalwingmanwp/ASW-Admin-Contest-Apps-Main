    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant={"outline"}
          className={cn("flex items-center h-12 rounded-e-none rounded-s-lg border-[#DDDDDD] border-[1px]")}
          disabled={disabled}
        >
...
const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
  ...
  return (
    <span className="bg-foreground/10 flex items-center justify-center h-4 w-5 overflow-hidden rounded-sm">
